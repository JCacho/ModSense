package ru.pvolan.strip1.f.temo;
...
public class TemperatureFragment extends android.support.v4.app.Fragment {
    ...
    public static TemperatureFragment getInstance (SensorInfo info) {
    ...
    public View onCreateView (LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate (R.layout.temperature_f_layout, container, false);
